...
public class BeautyItemBean implements Cloneable {
    ...
    public BeautyItemBean(BeautyType beautyType, @NonNull int title, int imageResId) {
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, boolean isSelected) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, int imageResId) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, int imageResId, boolean isSelected) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, int imageResId, int enableImageResId, boolean isSelected) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, int imageResId, int enableImageResId, float minValue, float maxValue, float value) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
    ...
    public BeautyItemBean(int id, BeautyType beautyType, @NonNull int title, int imageResId, int enableImageResId, @NonNull BeautyTabBean tabBean) {
        this.id = id;
        this.beautyType = beautyType;
        this.title = title;
