...
public class BeautyTabBean implements Cloneable {
    ...
    public BeautyTabBean(final int id, int title, ArrayList<BeautyItemBean> itemBeans) {
        this.id = id;
        this.title = title;
        this.itemBeans = itemBeans;
    }

    public BeautyTabBean(final int id, int title, boolean canMultiSelect, boolean isResetShow, ArrayList<BeautyItemBean> itemBeans) {
        this.id = id;
        this.title = title;
