...
public class QueenLookupDataInjector {
    /// *** 滤镜 *** ///
    private static final int ITEM_NAME_LUT_LOOKUP1 = R.string.item_name_lut_lookup1;
    private static final int ITEM_NAME_LUT_LOOKUP2 = R.string.item_name_lut_lookup2;
    private static final int ITEM_NAME_LUT_LOOKUP3 = R.string.item_name_lut_lookup3;
    private static final int ITEM_NAME_LUT_LOOKUP4 = R.string.item_name_lut_lookup4;
    private static final int ITEM_NAME_LUT_LOOKUP5 = R.string.item_name_lut_lookup5;
    private static final int ITEM_NAME_LUT_LOOKUP6 = R.string.item_name_lut_lookup6;
    private static final int ITEM_NAME_LUT_LOOKUP7 = R.string.item_name_lut_lookup7;
    ...
    private static final int ITEM_NAME_LUT_LOOKUP11 = R.string.item_name_lut_lookup11;
    private static final int ITEM_NAME_LUT_LOOKUP12 = R.string.item_name_lut_lookup12;
    ...
    private static final int ITEM_NAME_LUT_LOOKUP18 = R.string.item_name_lut_lookup18;
    //    private static final String ITEM_NAME_LUT_LOOKUP19 = "去掉";
    //    private static final String ITEM_NAME_LUT_LOOKUP20 = "清冷";
    private static final int ITEM_NAME_LUT_LOOKUP21 = R.string.item_name_lut_lookup21;
    ...
    private static final int ITEM_NAME_LUT_LOOKUP25 = R.string.item_name_lut_lookup25;
    //    private static final String ITEM_NAME_LUT_LOOKUP26 = "去掉";
    private static final int ITEM_NAME_LUT_LOOKUP27 = R.string.item_name_lut_lookup27;

    //    private static final String ITEM_NAME_LUT_ALI_WHITE = "阿里白";
    private static final int ITEM_NAME_LUT_YOUNG = R.string.item_name_lut_young;
    private static final int ITEM_NAME_LUT_REMEMBER = R.string.item_name_lut_remember;
    private static final int ITEM_NAME_LUT_ROMANTIC = R.string.item_name_lut_romantic;
    private static final int ITEM_NAME_LUT_FRESH = R.string.item_name_lut_fresh;
    private static final int ITEM_NAME_LUT_PURE = R.string.item_name_lut_pure;
    private static final int ITEM_NAME_LUT_BLUES = R.string.item_name_lut_blues;
    private static final int ITEM_NAME_LUT_ORIGINAL = R.string.item_name_lut_original;
