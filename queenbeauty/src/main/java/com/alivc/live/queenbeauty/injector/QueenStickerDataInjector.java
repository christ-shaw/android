...
public class QueenStickerDataInjector {
    /// *** 贴纸 *** ///
    private static final int ITEM_NAME_STICKER_BAIYANG = R.string.item_name_sticker_baiyang;
    //    private static final String ITEM_NAME_STICKER_BANDIANGOU = "斑点狗";
    private static final int ITEM_NAME_STICKER_BAZIHU = R.string.item_name_sticker_bazihu;
    ...
    private static final int ITEM_NAME_STICKER_BUOU = R.string.item_name_sticker_buou;
    ...
    private static final int ITEM_NAME_STICKER_EMOJI = R.string.item_name_sticker_emoji;
    ...
    private static final int ITEM_NAME_STICKER_HOUZI = R.string.item_name_sticker_houzi;
    private static final int ITEM_NAME_STICKER_HUXU = R.string.item_name_sticker_huxu;
    ...
    private static final int ITEM_NAME_STICKER_MAOERDUO = R.string.item_name_sticker_maoerduo;
    ...
    private static final int ITEM_NAME_STICKER_SHESHOU = R.string.item_name_sticker_sheshou;
    private static final int ITEM_NAME_STICKER_SHOUHUIHUZI = R.string.item_name_sticker_shouhuihuzi;
    ...
    private static final int ITEM_NAME_STICKER_TUZI = R.string.item_name_sticker_tuzi;
